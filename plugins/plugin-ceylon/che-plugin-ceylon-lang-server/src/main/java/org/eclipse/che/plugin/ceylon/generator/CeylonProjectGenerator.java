 ...
 *******************************************************************************/
package org.eclipse.che.plugin.ceylon.generator;
 ...
 */
public class CeylonProjectGenerator implements CreateProjectHandler {

    @Inject
    private VirtualFileSystemProvider virtualFileSystemProvider;

    private static final String FILE_NAME = "run.ceylon";
    ...
    public void onCreateProject(Path projectPath,
        ...
        baseFolder.createFile(FILE_NAME, getClass().getClassLoader().getResourceAsStream("files/default_ceylon_content"));
    }

    @Override
    public String getProjectType() {
        return ProjectAttributes.CEYLON_ID;
    }
}
