...
public class CeylonGinModule extends AbstractGinModule {
    ...
    protected void configure() {
        GinMultibinder.newSetBinder(binder(), ProjectWizardRegistrar.class).addBinding().to(CeylonProjectWizardRegistrar.class);
    }
    ...
    protected FileType provideCeylonFile() {
        return new FileType(CeylonResources.INSTANCE.ceylonFile(), CEYLON_EXT);
    }
