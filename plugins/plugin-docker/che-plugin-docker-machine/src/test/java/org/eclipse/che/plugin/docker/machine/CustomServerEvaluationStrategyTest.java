...
public class CustomServerEvaluationStrategyTest {
  ...
  private static final String WORKSPACE_ID_VALUE =
      CHE_WORKSPACE_ID_PREFIX + WORKSPACE_ID_WITHOUT_PREFIX_VALUE;
  private static final String WORKSPACE_ID_PROPERTY_PREFIX = "CHE_WORKSPACE_ID=";
  private static final String WORKSPACE_ID_PROPERTY =
      WORKSPACE_ID_PROPERTY_PREFIX + WORKSPACE_ID_VALUE;
  ...
  private static final String MACHINE_NAME_PROPERTY =
      MACHINE_NAME_PROPERTY_PREFIX + MACHINE_NAME_VALUE;

  private static final String IS_DEV_MACHINE_PROPERTY_PREFIX = "CHE_IS_DEV_MACHINE=";
  private static final String IS_DEV_MACHINE_PROPERTY_TRUE =
      IS_DEV_MACHINE_PROPERTY_PREFIX + "true";
  private static final String IS_DEV_MACHINE_PROPERTY_FALSE =
      IS_DEV_MACHINE_PROPERTY_PREFIX + "false";
  ...
  public void testOfflineInvalidExternal() throws Throwable {
    ...
    this.customServerEvaluationStrategy =
        new CustomServerEvaluationStrategy(
            "127.0.0.1", "300.300.300.300", "<externalAddress>-<workspaceId>", "https", "8080", null);
    CustomServerEvaluationStrategy.RenderingEvaluation renderingEvaluation =
        this.customServerEvaluationStrategy.getOfflineRenderingEvaluation(
            containerLabels, exposedPorts, env.stream().toArray(String[]::new));
    String eval = renderingEvaluation.render("<workspaceId>", "4401/tcp");
