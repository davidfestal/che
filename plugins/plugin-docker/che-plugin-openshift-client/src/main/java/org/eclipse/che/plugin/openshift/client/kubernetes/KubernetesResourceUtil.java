...
public final class KubernetesResourceUtil {
  ...
  public static Deployment getDeploymentByName(String deploymentName, String namespace, final Config config)
      throws IOException {
  ...
  public static Service getServiceBySelector(
      final String selectorKey, final String selectorValue, final String namespace, final Config config) {
    try (OpenShiftClient openShiftClient =
        new DefaultOpenShiftClient(config)) {
  ...
  public static List<Route> getRoutesByLabel(
      final String labelKey, final String labelValue, final String namespace, final Config config) throws IOException {
    try (OpenShiftClient openShiftClient =
        new DefaultOpenShiftClient(config)) {
      RouteList routeList =
