...
public class OpenShiftRouteCreator {
  ...
  public void createRoute(
    ...
    try (OpenShiftClient openShiftClient =
      ...
      String serviceHost = generateRouteHost(routeName, openShiftNamespaceExternalAddress, cheWorkspacesRoutingSuffix, namespace);
  ...
  private String generateRouteHost(
      ...
      final String cheWorkspacesRoutingSuffix, final String namespace) {
